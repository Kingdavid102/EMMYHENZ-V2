    ...
    if (isOwner) {
        if (match === 'on') {
            ...
            if (data.chatbot[chatId]) {
                return sock.sendMessage(chatId, { 
                    text: '* 🌿❄𝐄𝐌𝐌𝐘𝐇𝐄𝐍𝐙-𝐕2❄🌿 Chatbot is already enabled for this group*',
                    quoted: message
                });
            }
            data.chatbot[chatId] = true;
            saveUserGroupData(data);
            console.log(`🌿❄𝐄𝐌𝐌𝐘𝐇𝐄𝐍𝐙-𝐕2❄🌿 Chatbot enabled for group ${chatId}`);
            return sock.sendMessage(chatId, { 
                text: '*🌿❄𝐄𝐌𝐌𝐘𝐇𝐄𝐍𝐙-𝐕2❄🌿 Chatbot has been enabled for this group*',
                quoted: message
            });
        }
        ...
        if (match === 'off') {
            ...
            if (!data.chatbot[chatId]) {
                return sock.sendMessage(chatId, { 
                    text: '*🌿❄𝐄𝐌𝐌𝐘𝐇𝐄𝐍𝐙-𝐕2❄🌿 Chatbot is already disabled for this group*',
                    quoted: message
                });
            }
